  ...
  switch (@$_GET['action']) {
    case 'add':
      ...
      if (empty($error)) {
        ...
        $add = "INSERT INTO  building (code,name,address,building_scanner,latitude_longtitude) values('$code','$name','$address','','$location')";
    ...
    case 'update':
      ...
      if (empty($error)) {
        $update = "UPDATE building SET name='$name',
            address='$address', latitude_longtitude='$location' WHERE building_id='$id'";
