  ...
  <tbody>';
      ...
      if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
          if ($row['cuty_status'] == '1') {
            $status = '<span class="text-primary">Disetujui Kabag</span>';
          } elseif ($row['cuty_status'] == '2') {
            $status = '<span class="text-danger">Tidak Disetujui Kabag</span>';
          } elseif ($row['cuty_status'] == '4') {
            $status = '<span class="text-primary">Disetujui Kabinda</span>';
          } elseif ($row['cuty_status'] == '5') {
            $status = '<span class="text-danger">Tidak Disetujui Kabinda</span>';
          } else {
    ...
    <tr>
      ...
      <td class="text-center">
        <div class="btn-group">';
          if ($row_user['level_id'] == '4') {
            echo '
          <div class="btn-group" ' . ($row_user['is_update'] === '0' ? 'style="visibility:hidden"' : '') . '>
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a href="javascript:void(0);" data-id="' . $row['cuty_id'] . '" data-status="4" class="update-status">Setujui</a></li>
              <li><a href="javascript:void(0);" data-id="' . $row['cuty_id'] . '" data-status="5" class="update-status">Tidak disetujui</a></li>
            </ul>
          </div>
