...
if (empty($connection)) {
  ...
  $query_absent = "SELECT presence_id FROM presence WHERE presence_date='$date'";
  $result_count_absent = $connection->query($query_absent);

  $query_card = "SELECT id FROM business_card";
  $result_count_card = $connection->query($query_card);

  $query_cuty = "SELECT cuty_id FROM cuty";
  $result_count_cuty = $connection->query($query_cuty);
  echo '
<div class="content-wrapper" id="app" data-module="AdminDashboardModule">
<section class="content">
      <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>' . $result_count_card->num_rows . '</h3>
              <p>Tema ID Card</p>
            </div>
            <div class="icon">
              <i class="fa fa-retweet"></i>
            </div>
            <a href="./thema-card" class="small-box-footer">
              More Info <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>Laporan</h3>
              <p>Laporan Absensi per hari</p>
            </div>
            <div class="icon">
              <i class="fa fa-print"></i>
            </div>
            <a href=".//aporan-harian" class="small-box-footer">
              More Info <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-red">
            <div class="inner">
              <h3>' . $result_count_cuty->num_rows . '</h3>
              <p>Permohonan Cuti</p>
            </div>
            <div class="icon">
              <i class="fa fa-calendar-o"></i>
            </div>
            <a href="./cuty" class="small-box-footer">
              More Info <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
         ...
         <div class="col-lg-3 col-xs-6">
          <div class="small-box bg-green">
            ...
            <a href="./setting" class="small-box-footer">
              More Info <i class="fa fa-arrow-circle-right"></i>
            </a>
          </div>
        </div>
