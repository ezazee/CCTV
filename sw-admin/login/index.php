...
<div class="login-box">
  ...
  if ($_SESSION['success-reset']) {
    echo '<div class="alert alert-success alert-dismissible" role="alert">
          <strong>Selamat!</strong> silahkan cek emailmu untuk melakukan reset password.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>';
  };
  unset($_SESSION["success-reset"]);
  if ($_SESSION['success-reset-password']) {
    echo '<div class="alert alert-success alert-dismissible" role="alert">
          <strong>Selamat!</strong> password berhasil di reset.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>';
  };
  unset($_SESSION["success-reset-password"]);
  if ($_SESSION['user-not-found']) {
    echo '<div class="alert alert-danger alert-dismissible" role="alert">
          <strong>Maaf!</strong> User tidak ketemu.
          <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        </div>';
  };
    ...
    <p class="login-box-msg">Silahkan masukkan username dan password :</p>
     ...
     <hr>
      ...
      <div class="col-md-12" style="min-height:40px;"><span id="stat"></span></div>
        ...
        <a href="./forgot.html" class="btn btn-link">Lupa password</a>
        <!-- /.col -->
      </div>
