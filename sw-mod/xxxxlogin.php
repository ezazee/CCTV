 ...
 <!-- App Capsule -->
    <div id="appCapsule">
        ...
        <div class="section mt-2 text-center">
            ...
            <h4>Masukan Email dan Password Anda</h4>
        </div>
        <div class="section mb-5 p-2">
            ...
            <form id="form-login">
                ...
                <div class="form-button-group transparent">
                   <button type="xsubmit" class="btn btn-primary btn-block"><ion-icon name="log-in-outline"></ion-icon> Masuk</button>
                   <a href="xxoauth/google" class="btn btn-danger btn-block"><ion-icon name="logo-google"></ion-icon> Masuk Dengan Google</a>
                </div>
