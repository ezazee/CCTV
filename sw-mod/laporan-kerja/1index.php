        ...
        <form id="form-submit" class="ml-16 mr-16 mb-16">
          <div id="page1" class="">
            ...
            <div class="form-group">
              <input type="text" name="employe_name" class="form-control dari" placeholder="Dari" autocomplete="off" value="<?= $row_user['employees_name']; ?>">
              <input type="hidden" name="login" value="<?= $row_user['id']; ?>">
            </div>
            <div class="form-group">
        ...
        success: function(res) {
          ...
          if (res['success'] == true) {
            $.each(res['data'], function(index, view) {
              /*var id = atob(view['id']) */
              html += `
                            <div class="col-lg-4 col-md-4 col-sm-12 laporan-klik" data-nomor="${view['id']}">
                                <div class="col-12 card-laporan">  
                                    <p class="form-group col-12">
                                        Dari : 
                                        <span>${view['employe_name']}</span><br>
                                        Kepada : 
                                        <span>${view['kepada']}</span><br>
                                        <span>${view['created_at']}</span>
                                    </p><br>
                                    <label class="col-12 text-right">
                                    <button type="button" class="btn btn-success btn-sm btn-card btn-cetak-pdf">No Laporan : ${view['id']}</button>
                                    </label>
                                </div>
                            </div>   
                        `;
