...
if ($mod == '') {
  ...
  if (!isset($_COOKIE['COOKIES_MEMBER']) && !isset($_COOKIE['COOKIES_COOKIES'])) {
    ...
    echo '<!-- App Capsule -->
<div id="appCapsule">
  <div id="app" data-module="CutyModule">
            ...
            <form id="form-add-cuty" autocomplete="off">
              ...
              <div class="form-group basic">
                <div class="input-wrapper">
                  ...
                  <div class="input-group date" id="tglMasuk">
                    <input
                      type="text"
                      class="form-control"
                      name="date_work"
              ...
              <div class="form-group basic">
                <div class="input-wrapper">
                  ...
                  <textarea
                    rows="2"
                    class="form-control cuty_description"
                    name="cuty_description"
                    required
                  ></textarea>
                  <i class="clear-input"
                    ><ion-icon name="close-circle"></ion-icon
