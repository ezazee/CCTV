...
<!-- App Capsule -->
    <div id="appCapsule">
        ...
        ';
    if ($_SESSION['success-activation']) {
      echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Selamat!</strong> Pendaftaran mu berhasil, silahkan login.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>';
    };
    unset($_SESSION["success-activation"]);
    if ($_SESSION['user-notfound']) {
      echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                <strong>Maaf!</strong> Akun email mu belum terdaftar.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>';
                    ...
                    <div class="card-body pb-1">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="password" class="form-control m-b-2" id="password" name="password" placeholder="Kata sandi Anda">
                                <i class="clear-input"><ion-icon name="close-circle"></ion-icon></i>
                            </div>
                            <input type="checkbox" id="showPassword" style="margin-top: 20px; margin-right: 10px;"> Show Password
                        </div>
                    </div>
                </div>
        ...
        <div class="section wallet-card-section pt-1">
            <div class="wallet-card">
                ...
                <div class="wallet-footer">
                  ...
                  <div class="item">
                      <a href="./laporan-kerja">
                          <div class="icon-wrapper bg-success">
                            <ion-icon name="camera-outline"></ion-icon>
                          </div>
                          <strong>Laporan  Kerja</strong>
                      </a>
                  </div>
                  <div class="item">
                    <a href="./chat">
