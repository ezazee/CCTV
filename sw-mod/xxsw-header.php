...
<head>
  ...
  <meta name="theme-color" content="#1DCC70">
  <meta name="msapplication-navbutton-color" content="#1DCC70">
  <meta name="apple-mobile-web-app-status-bar-style" content="#1DCC70">
  ...
  <script src="https://sister-skominda.eagleye.id/sw-mod/sw-assets/js/html5-qrcode.min.js"></script>
  ';
...
<?php
    ...
    echo '
                        ...
                        <div class="in">
                            ...
                            <div class="text-muted">' . $row_user['employees_nip'] . '</div>
                        </div>
