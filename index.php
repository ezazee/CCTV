...
if (!isset($_COOKIE['COOKIES_MEMBER']) && !isset($_COOKIE['COOKIES_COOKIES'])) {
  ...
  if ($mod == 'registrasi') {
    require_once("sw-mod/registrasi.php");
  } else if ($mod == 'forgot') {
    require_once("sw-mod/forgot.php");
  } else {
    $mod = 'login';
  ...
  if ($mod === 'laporan-kerja') {
    if (file_exists("sw-mod/laporan-kerja/index.php")) {
      require_once("sw-mod/laporan-kerja/index.php");
    } else {
      require_once("sw-mod/home.php");
    }
  } else if ($mod === 'detail-laporan-kerja') {
    if (file_exists("sw-mod/detail-laporan-kerja/index.php")) {
      require_once("sw-mod/detail-laporan-kerja/index.php");
    } else {
      require_once("sw-mod/home.php");
    }
  } else {
